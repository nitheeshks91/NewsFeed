package com.app.announcement.customview;
...
/**
 * Modified the class since had some bug in the original source
 *
 * @author jlmd
 */
public class AnimatedCircleLoadingView extends FrameLayout {
    ...
    private void initAttributes(AttributeSet attrs) {
        TypedArray attributes =
                getContext().obtainStyledAttributes(attrs, com.github.jlmd.animatedcircleloadingview.R.styleable.AnimatedCircleLoadingView);
        mainColor = attributes.getColor(com.github.jlmd.animatedcircleloadingview.R.styleable.AnimatedCircleLoadingView_mainColor,
                Color.parseColor(DEFAULT_HEX_MAIN_COLOR));
        secondaryColor = attributes.getColor(com.github.jlmd.animatedcircleloadingview.R.styleable.AnimatedCircleLoadingView_secondaryColor,
                Color.parseColor(DEFAULT_HEX_SECONDARY_COLOR));
        checkMarkTintColor =
                attributes.getColor(com.github.jlmd.animatedcircleloadingview.R.styleable.AnimatedCircleLoadingView_checkMarkTintColor,
                        Color.parseColor(DEFAULT_HEX_TINT_COLOR));
        failureMarkTintColor =
                attributes.getColor(com.github.jlmd.animatedcircleloadingview.R.styleable.AnimatedCircleLoadingView_failureMarkTintColor,
                        Color.parseColor(DEFAULT_HEX_TINT_COLOR));
        textColor = attributes.getColor(com.github.jlmd.animatedcircleloadingview.R.styleable.AnimatedCircleLoadingView_textColor,
    ...
    public void restartDeterminate() {
        removeAllViews();
        init();
        startAnimationDeterminate = true;
        startDeterminate();
